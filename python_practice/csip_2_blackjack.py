...
Jun '20
Project: Blackjack
This project will take you off-platform and get you started in your own developer environment! Never done that before? Not to worry - we’ve shared some resources to help you down below. This project can be completed entirely on your own - or, you can join our Community on Discord 4 and find someone to work with! Jump to the community support section to hear more about this.

The project is broken down into a set of user stories 11 for you to follow. User stories are likely something you will see more and more of as you progress in your journey as a developer. They are short, simple descriptions of a feature told from the perspective of the individual using that feature. The goal of each user story is to describe to you, the developer, what the feature or application needs to do, while providing you with enough flexibility to determine the best way to make that happen.
...
Pre-requisites
In order to complete this project, we suggest that you have familiarity with the content in the following courses or lessons from the Codecademy Computer Science Path 8:
...
Blackjack 30
Python random module 7
Python lists 3
Python dictionaries 2
Python classes 2
Command line glossary 4
Python documentation 1
General Resources
How to get set-up for coding on your computer 4
What you need to know about Git, GitHub & Coding in Teams
How developer teams work
First steps in tackling a group project
Resource on writing pseudocode 6 to get started with off-platform projects
Video on how to use Chrome dev tools 3
Community Support
Looking for additional help or someone to work with (or somewhere to brag about your finished project)? Join our Community on Discord 4 to meet other learners like yourself!

Once you’re done…
Share in the Forums 7 for feedback and to see some other ways of solving this problem!
