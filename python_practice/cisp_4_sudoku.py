...
Jun '20
Project: Sudoku
This project will take you off-platform and get you started in your own developer environment! Never done that before? Not to worry - we’ve shared some resources to help you down below. This project can be completed entirely on your own - or, you can join our Community Discord 7 and find someone to work with! Jump to the community support section to hear more about this.

The project is broken down into a set of user stories 14 for you to follow. User stories are likely something you will see more and more of as you progress in your journey as a developer. They are short, simple descriptions of a feature told from the perspective of the individual using that feature. The goal of each user story is to describe to you, the developer, what the feature or application needs to do, while providing you with enough flexibility to determine the best way to make that happen.

Overview
Objective
Build a console application that allows the user to enter a 9x9 sudoku board, have the program solve it using depth-first search and produce the solution. Never played sudoku? It’s a logic-based, numbers placement game - you can read more about here 52!

Prerequisites
In order to complete this project, we suggest that you have familiarity with the content in the following courses or lessons from the Codecademy Computer Science Path 4:
...
Dictionaries introduction 1

Dictionaries continued 1

Milestone 10

Asymptotic notation introduction 1
...
Graph search introduction 4

Graph search continued 9
...
Python file input/output 2
Python documentation 2
Command line setup 2
Command line glossary 2
General Resources
How to get set-up for coding on your computer 10
What you need to know about Git, GitHub & Coding in Teams
How developer teams work 2
First steps in tackling a group project 1
Resource on writing pseudocode 2 to get started with off-platform projects
Video on how to use Chrome dev tools 1
User Stories: What are they? 2
Community Support
Looking for additional help or someone to work with (or somewhere to brag about your finished project)? Join our Community Discord 7 to meet other learners like yourself!

Once you’re done…
Share in the Forums 4 for feedback and to see some other ways of solving this problem!
