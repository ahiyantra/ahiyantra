...
Prerequisites
In order to complete this project, we suggest that you have familiarity with the content in the following courses or lessons from the Codecademy Computer Science Path 1:
...
Recursion introduction 6

Recursion continued 5
...
Recursion 1
Python lists 3
Python file input/output 7
Command line setup 4
Command line glossary 7
Python documentation 2
General Resources
How to get set-up for coding on your computer 6
What you need to know about Git, GitHub & Coding in Teams
How developer teams work 3
First steps in tackling a group project
Resource on writing pseudocode 1 to get started with off-platform projects
Video on how to use Chrome dev tools
User Stories: What are they? 2
Community Support
Want to Looking for additional help or someone to work with (or somewhere to brag about your finished project)? Join our Community Discord 2 to meet other learners like yourself!
